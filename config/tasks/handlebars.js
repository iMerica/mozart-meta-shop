/*
 * This is a customised Handlebars task for the sake of passing additional options to the
 * Handlebars.precompile call. This is necessary to provide data bindings to views.
 *
 * TODO: Consider creating a fork of 'grunt-contrib-handlebars' specifically for Mozart.
 *
 * All original credit for this file goes to Tim Branyen.
    ...
    grunt.registerMultiTask('handlebars', 'Compile handlebars templates and partials.', function() {
        ...
        this.files.forEach(function(files) {
            ...
            srcFiles.forEach(function(file) {
                ...
                try {
                    compiled = require('handlebars').precompile(src, {data:true});
